...
class TheColors {
  ...
  static Map<String, LinearGradient> pageColor = {
    WelcomePage.route: const LinearGradient(
      colors: [TheColors.welcomePrimary, TheColors.welcomeSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    ),
    TwitterPage.route: const LinearGradient(
      colors: [TheColors.twitterPrimary, TheColors.twitterSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    ),
    LinkedinPage.route: const LinearGradient(
      colors: [TheColors.linkedInPrimary, TheColors.linkedInSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    ),
    GithubPage.route: const LinearGradient(
      colors: [TheColors.githubPrimary, TheColors.githubSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    )
  };
